...
trial <- read.csv(file.path('E:/surfdrive/Documents/Master2019/Thomas/data/NewBivariate', paste('New',varname1,'_New',varname2, '_data_year.csv',  sep='')),header=T)
...
#We export the data
write.csv(data_sim,file.path('E:/surfdrive/Documents/Master2019/Thomas/data/NewBivariate','Simulated', paste('New',varname1,'_New',varname2, '_data_year.csv',  sep='')), na="nan",row.names=TRUE)
write.csv(summary_cop,file.path('E:/surfdrive/Documents/Master2019/Thomas/data/NewBivariate','Simulated', paste('New',varname1,'_New',varname2, '_copulatype_year.csv',  sep='')))